...
const institutionsData = [
  ...
  { name: "Singhania University", location: "Jhunjhunu", image: "https://media.licdn.com/dms/image/v2/D560BAQGZR9p94CbWvg/company-logo_200_200/B56ZvFPbz2KMAI-/0/1768540716893/singhania_university_pacheri_bari_logo?e=2147483647&v=beta&t=OypqIKWEJqYzYO0cfKjbVxsTzfnbVd3-JugWs1No3uU" },
  
  // Universities from your table - adding logos where available
  { name: "CMJ University", location: "Shillong", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLmY2j8rcRR6uhsEPZZCrpmHlLhhINa--2cQ&s" },
  { name: "Asian International University", location: "Imphal", image: "https://content.jdmagicbox.com/comp/imphal/d2/9999p3852.3852.210921225345.g2d2/catalogue/asian-international-university-lamsang-imphal-universities-ojivpofh56.jpg" },
  { name: "Bir Tikendrajit University", location: "Imphal", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToFFNUCoazvSbbf1igCrkT8fL9KMixc2YVKQ&s" },
  { name: "Bhabha University", location: "Bhopal", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkx7w9moVKQGrsCkEwLLX51LtW1eemQ92I8g&s" },
  { name: "Dr. A.P.J. Abdul Kalam University", location: "Indore", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5EbDf_BU1vDotRz4i4lh23z6MWsHyutIh7Q&s" },
  { name: "Dr. C.V. Raman University, Khandwa", location: "Khandwa", image: "https://upload.wikimedia.org/wikipedia/en/1/14/Dr._C.V._Raman_University_logo.png" },
  { name: "Dr. Preeti Global University", location: "Shivpuri", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOqK9k0blcVUb2TP4XJk80BrYGn_zwMJGOtA&s" },
  { name: "Madhyanchal Professional University", location: "Bhopal", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ90oef8YyIzg8b3h7Sy583A41sOjjOBEppIA&s" },
  { name: "Mahakaushal University", location: "Jabalpur", image: "https://mku.ac.in/wp-content/uploads/2025/03/LOGO-PNG.png" },
  { name: "Shri Krishna University", location: "Chhatarpur", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHSl3-zkPKiWWMseogJrHFl_X-x74ePA1XDQ&s" },
  { name: "P.K. University", location: "Shivpuri", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzpmEnOonBEo4WcW5phzXBInpu1vH9roa8lg&s" },
  { name: "Swami Vivekanand University", location: "Sagar", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeRVMzQNrP9hoykbLm0eMx2wugabJRwRZQ7w&s" },
  { name: "Sai Nath University", location: "Ranchi", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJfejR5AQpct3Pkwju3udF00t7j9Zii7uK8A&s" },
  { name: "Sarala Birla University", location: "Ranchi", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSST8IMBRTIHOL3S49Re-th2XtaqousEPY1A&s" },
  { name: "Sona Devi University", location: "East Singhbhum", image: "https://mycareersview.com/afile/mcv25538_channels4_profile.jpg" },
  { name: "YBN University", location: "Ranchi", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0gwwPg-MZxlHz09FEAWFfOiQ-ZrQ8MhfObg&s" },
  { name: "NIILM University, Kaithal", location: "Kaithal", image: "https://files.gallabox.com/6607e92f85a0406578eb3e96/f853bc13-b3bd-496e-be66-438ab62ec194-Untitleddesign32.png" },
  { name: "Om Sterling Global University", location: "Hisar", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTl_32S-tHZhaxVrtn2_egkeMpOGil-A27cKg&s" },
  { name: "Monark University", location: "Ahmedabad", image: "https://monarkuni.ac.in/img/logo/MULOGOR.png" },
  { name: "Sabarmati University", location: "Ahmedabad", image: "https://upload.wikimedia.org/wikipedia/en/2/2a/Sabarmati_University_Logo.png" },
  { name: "Sardar Vallabhbhai Global University", location: "Ahmedabad", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsUQj1YyeihYhzy183cLJ0pxIuh4tm7d4JjA&s" },
  { name: "K. K. Modi University", location: "Durg", image: "https://kkmu.edu.in/wp-content/uploads/2024/03/logony.png" },
  { name: "Kalinga University", location: "Raipur", image: "https://www.kalingauniversity.ac.in/images/logo23.png" },
  { name: "Apex Professional University", location: "Gumin Nagar", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRj_lWVxrmJa-93lSuLh9a4UMInXgfEhpRJHQ&s" },
  { name: "North East Frontier Technical University", location: "Aalo", image: "https://upload.wikimedia.org/wikipedia/en/0/07/North_East_Frontier_Technical_University_logo.png" },
  { name: "Arunodaya University", location: "Itanagar", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQs6Se6XKPPe45JFwize3dGlWqyLrIuIQZ7A&s" },
  { name: "Godavari Global University", location: "Rajamahendravaram", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRg-sUXlOU9MO6fP61QH2WLKKRJ-8EP4Zidw&s" },
  { name: "Krea University", location: "Sri City", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyH4p0-a52OyJU2pvhFq1tg90tMdP08LxWGQ&s" },
  { name: "Mohan Babu University", location: "Tirupati", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVmPVACmTMh5tvkyWgYd2MktDcmyJN1ogN8A&s" },
];
